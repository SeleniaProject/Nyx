...
//! - **Plus**: Multipath, Hybrid Post-Quantum (default recommended)
...
impl ComplianceRequirements {
    ...
    pub fn plus() -> Self {
        ...
        required.insert("capability_negotiation".to_string());
...
impl FeatureDetector {
    ...
    pub fn new() -> Self {
        ...
        features.insert("capability_negotiation".to_string());
