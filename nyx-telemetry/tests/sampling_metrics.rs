...
async fn sampling_counters_exposed() {
    ...
    let cfg = TelemetryConfig { metrics_enabled: true, metrics_port: 19333, collection_interval: 60, otlp_enabled: false, otlp_endpoint: None, trace_sampling: 0.2, attribute_filter_config: None, exporter_recovery: true };
    ...
    for pid in 0..50u8 { record_stream_send(pid, "cid-sample"); }
