...
pub mod path_builder_broken;
#[cfg(feature = "experimental-metrics")]
pub mod prometheus_exporter; // export prometheus exporter for integration tests
#[cfg(feature = "experimental-metrics")]
pub mod zero_copy_bridge; // export zero-copy metrics bridge for tests/integration // heavy module guarded by feature
#[cfg(feature = "path-builder")]
pub use path_builder_broken as path_builder; // maintain expected name
#[cfg(feature = "experimental-alerts")]
pub mod alert_system;
pub mod pure_rust_dht; // always expose minimal DHT for integration // alert system

// Helper exported items
#[cfg(feature = "path-builder")]
pub use path_builder_broken::{PathBuilder, PathBuilderConfig};
...
pub static GLOBAL_PATH_PERFORMANCE_REGISTRY: Lazy<PathPerformanceRegistry> =
    Lazy::new(|| PathPerformanceRegistry::new());
