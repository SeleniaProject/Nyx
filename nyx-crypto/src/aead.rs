...
use chacha20poly1305::aead::{Aead, Payload, NewAead};
...
impl Drop for AeadKey { fn drop(&mut self) { self.0.zeroize(); } }
...
impl AeadCipher {
	pub fn new(suite: AeadSuite, key: AeadKey) -> Self { Self { suite, key } }
